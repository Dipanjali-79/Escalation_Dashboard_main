export const BRANCHES = ["Andhra Pradesh", "Bangalore", "Chennai", "Delhi", "Haryana", "Hyderabad", "Madhya Pradesh", "Mum_Thn", "Pune", "Punjab", "Rajasthan", "RO TEL", "RO KAR", "RO TN", "ROM", "UP EAST", "Uttar Pradesh", "West Bengal", "UP WEST"];
